...
realpath = os.path.join(realpath[0]+_sep, *realpath[1:-2])
sys.path.append(realpath)

import torch.nn as nn
import torch.nn.functional as F
from builder.normal_builder import ConvBuilder
...
def create_ResNet18(cfg, builder, num_classes):
    return ResNet(builder, BasicBlock, [2,2,2,2], num_classes=num_classes)

def create_ResNet34(cfg, builder, num_classes):
    return ResNet(builder, BasicBlock, [3,4,6,3], num_classes=num_classes)

def create_ResNet50(cfg, builder, num_classes):
    return ResNet(builder, Bottleneck, [3,4,6,3], num_classes=num_classes)
