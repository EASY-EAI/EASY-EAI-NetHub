...
def get_blocks(num_layers):
    if num_layers == 50:
        ...
        blocks = [
            ...
            get_block(in_channel=256, depth=256, num_units=2)
        ]
...
class Backbone(Module):
    ...
    # def forward(self, x, label,shortcut):
...
# def IR_20(input_size):
#     """Constructs a ir-20 model.
#     """
#     model = Backbone(input_size, 20, 'ir')
